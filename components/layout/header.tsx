  ...
  return (
    <header className="sticky top-0 z-50">
      {/*
        ...
        On scroll: shrinks padding so the pill "floats" above page content.
        Before scroll: flush with top edge, full width feel.
      */}
      <div
        className={cx(
          "transition-all duration-300 ease-out",
          scrolled ? "px-4 pt-3 pb-0 md:px-8" : "px-0 pt-0 pb-0"
        )}
      >
        <motion.div
          className={cx(
            "relative flex items-center justify-between",
            "border border-border bg-header/80 backdrop-blur-xl",
            "transition-all duration-300",
            // Pill shape when scrolled, square when at top
            scrolled
        ...
        >
          {/*
            Subtle tangerine inner glow — only visible when floating.
            Gives the pill a warm "lit from within" feel.
          */}
          <div
            className={cx(
            ...
            style={{
              background:
                "radial-gradient(ellipse 60% 80% at 50% 0%, rgba(255,122,53,0.07) 0%, transparent 70%)",
            }}
          />
          ...
          >
            ...
            <div className="hidden sm:block leading-tight">
              ...
              <div className="text-[10px] font-medium tracking-widest uppercase text-accent opacity-80">
                Company
              </div>
            </div>
          </Link>
          ...
          <LayoutGroup id="header-nav">
            <nav
              className="hidden items-center gap-0.5 md:flex z-10"
              ...
              {NAV.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={href}
                    className={cx(
                      "relative rounded-xl px-3.5 py-2 text-[13px] font-medium transition-all duration-150",
                      active
          ...
          <div className="flex items-center gap-2 z-10">
            ...
            <Link
              ...
              className={cx(
                ...
                "hover:bg-accent2 hover:-translate-y-px",
                "active:scale-[0.98]",
                "shadow-[0_4px_14px_rgba(255,122,53,0.35)]"
              )}
            >
              Contact Us
            </Link>
      ...
      <AnimatePresence>
        {open && (
          <>
            ...
            <motion.button
              type="button"
              className="fixed inset-0 top-16 z-40 md:hidden cursor-default"
            ...
            >
              <div
                className={cx(
                  ...
                  "border border-border bg-surface",
                  "shadow-[0_20px_60px_rgba(0,0,0,0.55),0_0_0_1px_rgba(255,122,53,0.08)]"
                )}
              >
                {/* Warm glow top edge */}
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, transparent, rgba(255,122,53,0.5), transparent)",
                  }}
                />
                  ...
                  {NAV.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        onClick={closeMenu}
                        className={cx(
                          "flex items-center justify-between rounded-xl px-4 py-3 text-sm transition-all duration-150",
                          active
                ...
                <div className="px-3 pb-3">
                  <Link
                    ...
                    className={cx(
                      ...
                      "shadow-[0_4px_14px_rgba(255,122,53,0.3)]",
